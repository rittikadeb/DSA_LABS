...
*blackPeg = *whitePeg = 0;
for (i = 0; i < 4; i++) //if secret’s and guess's position and color are same, blackpeg increases and marks "check"
{
...
{
if (wrongGuess == 1)
printf("The secret code may consist of any of the following colors:\n 1.Red\n2.Blue\n3.Green\n4.Yellow\n5.Orange\n6.Purple \n");
guess(guessCode);
